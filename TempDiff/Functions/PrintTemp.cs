namespace WeatherApp.Functions
{
    internal class Print
    {
        ...
        {
            var (min, max) = TempCalc.MinMaxTemp(weatherByDays);
            ...
            {
                if (min.Day == day.Day) { Console.ForegroundColor = ConsoleColor.Blue; }  //highlight min. variation
                if (max.Day == day.Day) { Console.ForegroundColor = ConsoleColor.Red; }  //highlight max. variation
